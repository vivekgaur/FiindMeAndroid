...
public class JSONListView1Activity extends ListActivity {
	// JSON Node names
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        //String URI = "http://10.0.2.2/~vgaur/fiindme/index.php/find/deal" + "/" + zipCode; 
      	glob.setDeviceID(JSONListView1Activity.this);
	...
	public void parsePopulateListView(String inputStr){
        ...
        try{
            ...
            for(int i = 0; i < deals.length(); i++){
             ...
             // adding each child node to HashMap key => value
                ...
                map.put(TAG_IMAGE,Integer.toString(R.drawable.ic_food));
        ...
        ListAdapter adapter = new SimpleAdapter(this, dealList,
                R.layout.activity_jsonlist_view1,
                new String[] { TAG_DEAL_ID, TAG_MERCHANT_ID, TAG_TITLE,TAG_STARTTIME,TAG_ENDTIME,TAG_STATUS,TAG_IMAGE}, new int[] {
	...
	private class LongRunningGetIO extends AsyncTask <Void, Void, String> {
		...
		protected void onPostExecute(String results) {
			...
			JSONListView1Activity.this.parsePopulateListView(results);
